...
TEST(transaction, construct_transaction) {
	...
	ASSERT_STREQ("DAYS6o9sA51kMCSaSP216GZ8pomGkRsQiR", transaction.sender_id().description());
	ASSERT_STREQ("D7FyqZohN83vxQdqUjJWqD2CPQBxhut9WD", transaction.recipient_id().description());
	ASSERT_STREQ("039b5a3a71335bfa6c72b82498f814123e0678f7cd3d8e7221ec7124918736e01c", transaction.sender_publickey().description());
