...
ARK::Transaction ARK::API::Transaction::Gettable::transactionfromJSON(const char* const jsonStr)
{
	...
	return {
		...
		Balance(parser.valueIn("transaction", "amount")),
		Balance(parser.valueIn("transaction", "fee")),
		parser.valueIn("transaction", "vendorField"),
		Address(parser.valueIn("transaction", "senderId")),
		Address(parser.valueIn("transaction", "recipientId")),
		Publickey(parser.valueIn("transaction", "senderPublicKey")),
