...
/**************************************************************************************************/
		...
		**************************************************/
    ARK::API::Delegate::Respondable::NextForgers nextForgers(ARK::Utilities::Network::Connector& netConnector);
...
*   /api/delegates/count
**************************************************/
int ARK::API::Delegate::Gettable::count(ARK::Utilities::Network::Connector& netConnector)
{
...
*
**************************************************/
int ARK::API::Delegate::Gettable::countfromJSON(const char* const jsonStr)
{
...
*
**************************************************/
ARK::API::Delegate::Respondable::Search ARK::API::Delegate::Gettable::searchfromJSON(const char* const jsonStr)
{
	ARK::Utilities::JSONParser parser(jsonStr, strlen(jsonStr));
...
*
**************************************************/
ARK::Delegate ARK::API::Delegate::Gettable::delegatefromJSON(const char* jsonStr)
{
	ARK::Utilities::JSONParser parser(jsonStr, strlen(jsonStr));
...
*   /api/delegates/fee
**************************************************/
Balance ARK::API::Delegate::Gettable::fee(ARK::Utilities::Network::Connector& netConnector)
{
...
*
**************************************************/
Balance ARK::API::Delegate::Gettable::feefromJSON(const char* const jsonStr)
{
  ARK::Utilities::JSONParser parser(jsonStr, strlen(jsonStr));
...
*
**************************************************/
ARK::API::Delegate::Respondable::ForgedByAccount ARK::API::Delegate::Gettable::forgedByAccountfromJSON(const char* const jsonStr)
{
	ARK::Utilities::JSONParser parser(jsonStr, strlen(jsonStr));
...
*
**************************************************/
ARK::API::Delegate::Respondable::NextForgers ARK::API::Delegate::Gettable::nextForgersfromJSON(const char* const jsonStr)
{
	ARK::Utilities::JSONParser parser(jsonStr, strlen(jsonStr));
