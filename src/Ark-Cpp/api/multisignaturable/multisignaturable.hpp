...
#ifndef MULTISIGNATURABLE_HPP
#define MULTISIGNATURABLE_HPP

#include "multisignature_gettable.hpp"
...
**************************************************/
class MultiSignaturable : public MultiSignature::Gettable,
													virtual ARK::Utilities::Network::Connectable
{
public:
	/*************************************************
	...
	*   calls:	ARK::API::MultiSignature::Gettable::pending(this->netConnector, _publicKey)
	*
	*   @brief:
