...
public:
	...
	**************************************************/
	...
	size_t get_transaction_bytes(uint8_t buffer[512], bool skip_signature = false, bool skip_second_signature = false) const;
	Sha256Hash get_hash(bool skip_signature = false, bool skip_second_signature = false) const;
	void generate_id();
	/*************************************************/
